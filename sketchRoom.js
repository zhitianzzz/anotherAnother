...
const paraInstruction1 = "To view the next part of the work\nPlease spread your fingers\ngently wave your hand from left to right.";
...
function processKeypoints() {
  ...
  for (let i = 0; i < hands.length; i++) {
    ...
    if (thumbPrevPos) {
      ...
      // Check conditions and update textContent
      if (thumbSpeed > 7000 && pinchDistance > 50 && isMovingRightToLeft) {
